...
/**
 * Ensures that the tree-sitter parser is generated by checking for src/parser.c
 */
async function ensureParserGenerated(grammarDir) {
	const parserCPath = path.join(grammarDir, "src", "parser.c");
	try {
		await fs.access(parserCPath);
	} catch {
